...
const translations: Dict = {
  ...
  offers_title: { ar: "العروض", en: "Offers", he: "מבצעים" },
  offers_products: { ar: "منتجات مخفّضة", en: "Discounted products", he: "מוצרים מוזלים" },
  offers_none: {
    ar: "لا توجد عروض حالياً — تابعنا قريباً!",
    en: "No offers right now — check back soon!",
    he: "אין מבצעים כעת — חזרו בקרוב!",
  },
  offers_shop: { ar: "تسوّق العروض", en: "Shop offers", he: "למבצעים" },
  offers_code_copied: { ar: "تم نسخ كود الخصم", en: "Coupon code copied", he: "הקוד הועתק" },
  promos_title: { ar: "المناسبات والعروض", en: "Occasions & Promos", he: "מבצעים ואירועים" },
  promos_hint: {
    ar: "أنشئ مناسبة (عيد، جمعة بيضاء…) تظهر كبانر بالموقع وتروّج للعروض.",
    en: "Create an occasion (Eid, Black Friday…) shown as a banner that promotes your offers.",
    he: "צור אירוע (חג, בלאק פריידי…) שיוצג כבאנר ומקדם את המבצעים.",
  },
  promos_none: { ar: "لا توجد مناسبات بعد", en: "No promotions yet", he: "אין מבצעים עדיין" },
  promo_need_title: { ar: "أدخل عنوان المناسبة", en: "Enter a title", he: "הזן כותרת" },
  promo_title_ar: { ar: "العنوان (عربي)", en: "Title (Arabic)", he: "כותרת (ערבית)" },
  promo_title_en: { ar: "العنوان (إنجليزي)", en: "Title (English)", he: "כותרת (אנגלית)" },
  promo_subtitle: { ar: "وصف قصير", en: "Short subtitle", he: "כתובית קצרה" },
  promo_coupon: { ar: "كود خصم (اختياري)", en: "Coupon code (optional)", he: "קוד קופון (אופציונלי)" },
  ...
  admin_categories: { ar: "الأقسام", en: "Categories", he: "קטגוריות" },
  cat_need_name: { ar: "أدخل اسم القسم", en: "Enter a category name", he: "הזן שם קטגוריה" },
  cat_icon: { ar: "اسم الأيقونة (Cpu, Zap…)", en: "Icon name (Cpu, Zap…)", he: "שם אייקון" },
  cat_parent: { ar: "القسم الأب", en: "Parent category", he: "קטגוריית אב" },
  cat_no_parent: { ar: "بدون أب (قسم رئيسي)", en: "No parent (top level)", he: "ללא אב" },
  cat_description: { ar: "وصف القسم (اختياري)", en: "Description (optional)", he: "תיאור (אופציונלי)" },
  name: { ar: "الاسم", en: "Name", he: "שם" },
  ...
  promote: { ar: "ترقية لمدير", en: "Make admin", he: "הפוך למנהל" },
  demote: { ar: "إزالة الإدارة", en: "Remove admin", he: "הסר ניהול" },
  delete_review: { ar: "حذف المراجعة", en: "Delete review", he: "מחק ביקורת" },
  saved_addresses: { ar: "العناوين المحفوظة", en: "Saved addresses", he: "כתובות שמורות" },
  add_address: { ar: "إضافة عنوان", en: "Add address", he: "הוסף כתובת" },
  no_addresses: {
    ar: "لا عناوين محفوظة بعد — أضف واحداً ليصير الدفع أسرع.",
    en: "No saved addresses yet — add one for faster checkout.",
    he: "אין כתובות שמורות — הוסף אחת לתשלום מהיר.",
  },
  address_incomplete: {
    ar: "أكمل الاسم والعنوان والمدينة",
    en: "Fill name, address and city",
    he: "מלא שם, כתובת ועיר",
  },
  default_address: { ar: "افتراضي", en: "Default", he: "ברירת מחדל" },
  set_default_address: {
    ar: "اجعله العنوان الافتراضي",
    en: "Make this my default address",
    he: "הגדר ככתובת ברירת מחדל",
  },
  ...
  barcode: { ar: "الباركود", en: "Barcode", he: "ברקוד" },
  tags: { ar: "وسوم", en: "Tags", he: "תגיות" },
  video_url: { ar: "رابط فيديو", en: "Video URL", he: "קישור וידאו" },
  ...
  footer_service: { ar: "خدمة العملاء", en: "Customer Service", he: "שירות לקוחות" },
  footer_follow: { ar: "تابعنا", en: "Follow us", he: "עקבו אחרינו" },
  footer_payments: { ar: "طرق الدفع", en: "We accept", he: "אמצעי תשלום" },
  footer_made: {
    ar: "صُنع بشغف لعشّاق الإلكترونيات",
    en: "Built with passion for electronics lovers",
    he: "נבנה באהבה לחובבי אלקטרוניקה",
  },
  newsletter_title: { ar: "النشرة البريدية", en: "Newsletter", he: "ניוזלטר" },
  newsletter_d: {
    ar: "اشترك لتصلك العروض والمنتجات الجديدة.",
    en: "Subscribe for offers and new arrivals.",
    he: "הירשמו למבצעים ומוצרים חדשים.",
  },
  newsletter_placeholder: { ar: "بريدك الإلكتروني", en: "Your email", he: "האימייל שלך" },
  newsletter_subscribe: { ar: "اشترك", en: "Subscribe", he: "הרשמה" },
  newsletter_done: {
    ar: "تم الاشتراك — شكراً لك!",
    en: "Subscribed — thank you!",
    he: "נרשמת — תודה!",
  },
  about_title: { ar: "من نحن", en: "About Us", he: "אודותינו" },
  about_values_title: { ar: "لماذا كهربا بلس؟", en: "Why Electrical Plus?", he: "למה כהרבא פלוס?" },
  about_contact_title: { ar: "تواصل معنا", en: "Get in touch", he: "צרו קשר" },
  about_contact_d: {
    ar: "عندك سؤال عن منتج أو طلب؟ فريقنا جاهز لمساعدتك.",
    en: "Have a question about a product or order? Our team is here to help.",
    he: "יש לך שאלה על מוצר או הזמנה? הצוות שלנו כאן בשבילך.",
  },
  stat_products: { ar: "منتج", en: "Products", he: "מוצרים" },
  stat_customers: { ar: "عميل سعيد", en: "Happy customers", he: "לקוחות מרוצים" },
  stat_years: { ar: "سنوات خبرة", en: "Years of experience", he: "שנות ניסיון" },
  stat_support: { ar: "دعم فني", en: "Support", he: "תמיכה" },
